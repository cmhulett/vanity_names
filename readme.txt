A short script for replacing city names with vanity citiy names in a variety of binary data files with txt extensions. The data files have a fixed width of 346 bytes. 3MA_TEST.txt has a same data file.
