...
state_abbreviation was used to build the path to the files, file_id is a 3 digit code used to differentiate gorgraphical regions as they are separeted from the data provider, and census_tracts are a way of separating geographical locations for determining if they are in the city area or not.
...
Built and tested on windowsXP and server 2000 running from py2exe executable.